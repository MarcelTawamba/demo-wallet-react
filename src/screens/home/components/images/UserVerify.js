  ...
  return (
    <svg
      ...
      <defs>
        ...
        <clipPath id="clip-Verify">
          <rect width="100" height="100" />
        </clipPath>
      </defs>
      <g id="Verify" clipPath="url(#clip-Verify)">
        <g id="verify-2" data-name="verify" transform="translate(174 9418)">
          <g
            ...
            <path
              ...
              d="M39.375,45a22.5,22.5,0,1,0-22.5-22.5A22.5,22.5,0,0,0,39.375,45Zm15.75,5.625H52.189a30.6,30.6,0,0,1-25.629,0H23.625A23.631,23.631,0,0,0,0,74.25v7.313A8.44,8.44,0,0,0,8.438,90H70.313a8.44,8.44,0,0,0,8.438-8.437V74.25A23.631,23.631,0,0,0,55.125,50.625Z"
