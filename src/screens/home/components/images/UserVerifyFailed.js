...
export default function UserVerifyFailed(props) {
  ...
  return (
    <svg
      ...
      <g id="Verify-failed" clipPath="url(#clip-path)">
            ...
            <g
              ...
              <g id="checklist" transform="translate(195.099 275.099)">
                ...
                <path
                  ...
                  d="M2.425-1.681H6.8L7.893-17.5H1.331ZM4.612,7.007A3.216,3.216,0,0,0,8,3.857,3.142,3.142,0,0,0,4.612.776,3.142,3.142,0,0,0,1.225,3.857,3.216,3.216,0,0,0,4.612,7.007Z"
                  transform="translate(23.289 33.147)"
                  fill="#fff"
                />
              </g>
            </g>
