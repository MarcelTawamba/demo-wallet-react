...
export default function RewardTransaction(props) {
    ...
    <svg
      ...
      <g id="transaction-rewards" clipPath="url(#clip-transaction-rewards)">
        ...
        <path
          ...
          d="M1482.093,4055.94l-9.1,10.37h34.159"
          transform="translate(-1389 -3939)"
          fill="none"
          stroke="#020d88"
          strokeLinecap="round"
          strokeWidth="8"
        ...
        <path
          ...
          d="M1498.055,4066.311l9.1-10.37h-34.159"
          transform="translate(-1392 -3911)"
          fill="none"
          stroke="#020d88"
          strokeLinecap="round"
          strokeWidth="8"
