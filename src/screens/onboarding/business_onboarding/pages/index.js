...
import OnboardingContainer from 'screens/onboarding/business_onboarding/components/OnboardingContainer';
import {
  updateProfile,
  updateProfileImage,
...
import { BusinessConfig, UserConfig } from 'screens/onboarding/config';
...
export default function BusinessOnboarding(props) {
  const { colors } = useTheme();

  const { company, fetchData, isBusinessGroup, setIsUserOnboarding } = props;
