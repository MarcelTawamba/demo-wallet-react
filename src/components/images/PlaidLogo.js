...
export default function PlaidLogo({ width = 90, height = 90 }) {
  return (
    <svg
      ...
      <g
        id="Plaid_icon"
        data-name="Plaid icon"
        transform="translate(-799 -260)">
        <rect
          id="Rectangle_3709"
